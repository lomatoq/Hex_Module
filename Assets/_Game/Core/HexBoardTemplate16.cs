...
namespace HexWords.Core
{
    public static class HexBoardTemplate16
    {
        ...
        {
            // Сіметрычнае поле [3‑4‑5‑4]: кожны шэраг цэнтраваны па X
            // r=−2 (верх,  3): c7  c11 c14
            // r=−1 (4):        c4  c8  c12 c15
            // r= 0 (цэнтр, 5): c1  c5  c9  c13 c16
            // r= 1 (ніз,   4): c2  c6  c10 c3
            (-2, 0), (-2, 1), ( 1, 1),          // c1  c2  c3
            (-1,-1), (-1, 0), (-1, 1),          // c4  c5  c6
            ( 0,-2), ( 0,-1), ( 0, 0), ( 0, 1), // c7  c8  c9  c10
            ( 1,-2), ( 1,-1), ( 1, 0),          // c11 c12 c13
            ( 2,-2), ( 2,-1), ( 2, 0)           // c14 c15 c16
        };
